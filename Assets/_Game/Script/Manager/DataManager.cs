...
public class DataManager : Singleton<DataManager>
{
    ...
    private void Start()
    {
        ...
        OnDataChanged += LevelManager.Instance.OnDataChanged;
    ...
    {
        if(currentLevel + 1 > LevelUtils.MAX_LEVEL)
        {
            return 1;
        }
    ...
    {
        SetData(DataType.Coin, coins + CoinUtils.COIN_PER_LEVEL);
    }
    
    public void OnClickCTABtn()
    {
        SetData(DataType.Coin, coins + CoinUtils.COIN_PER_ADS);
    }
